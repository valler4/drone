...
Route::name('api.')->prefix('/v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/profile/friend_request/{user}', [ProfileController::class, 'sendFriendRequest']);
        Route::delete('/profile/friend_request/{user}', [ProfileController::class, 'deleteFriendRequest']);

        Route::post('/password', [SecurityController::class, 'updatePassword']);
        Route::post('/pin_code', [SecurityController::class, 'updatePinCode']);
        ...
        Route::get('/my_products', [ProductController::class, 'mine']);
