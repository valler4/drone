            ...
            <div class="form-control w-full">
                ...
                <div class="flex flex-col md:flex-row items-stretch gap-3">
                    <input type="tel" id="user-phone" name="phone" value="{{ old('phone') }}"
                        class="input bg-base-200 dark:bg-slate-900 border-none focus:ring-2 ring-primary rounded-2xl font-medium flex-1 dark:text-white @error('phone') ring-2 ring-error @enderror"
